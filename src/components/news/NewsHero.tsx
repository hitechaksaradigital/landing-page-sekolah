    ...
    <section className="px-margin-page max-w-container-max mx-auto mb-stack-lg">
      <div className="relative h-[500px] md:h-[600px] rounded-xl overflow-hidden border border-white/10 group">
        <div
          ...
          data-alt="A cinematic, wide-angle shot of a group of diverse middle school students standing proudly behind a futuristic humanoid robot they built. The setting is a high-tech laboratory with glowing blue interfaces and clean white surfaces at SMPN 1 Hitech. The lighting is dramatic, with cool cyan neon accents contrasting against a dark, professional navy background. The mood is triumphant and innovative, capturing a moment of international victory in robotics."
          style={{
            backgroundImage:
